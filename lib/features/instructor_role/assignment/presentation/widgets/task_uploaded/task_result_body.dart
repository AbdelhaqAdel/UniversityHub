                ...
                child: Column(
                  children: [
                    Row(
                      ...
                      children: [
                        const FaIcon(FontAwesomeIcons.solidUser,color: Colors.teal,size: 18,),
                    ...
                    TaskResultListView( taskId:taskId ,),
                  ],
                ),
              ),
            ),
...
class StudentTaskInfo extends StatelessWidget {
  const StudentTaskInfo({super.key, this.studentTaskUploadedEntity, required this.index, required this.taskId});
      ...
      children: [
        ...
        InkWell(
          ...
          child: Container(
            ...
            child: const Padding(
              padding:
              EdgeInsets.symmetric(vertical: 1.0, horizontal: 6),
              child: Text(
                'more',
                style: TextStyle(
                  color: Colors.teal,
