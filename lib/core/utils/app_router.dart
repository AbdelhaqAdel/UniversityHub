    ...
    routes: [
          ...
          builder: (context, state) {
            ...
            return BlocProvider.value(
              value: context1!.read<MaterialCubit>()
                ..fetchMaterialFiles(lecId: lecId),
      ...
      GoRoute(
        ...
        builder: (context, state) {
          //  final quizId = state.extra as String;
          return BlocProvider.value(
            value: context1!.read<QuizCubit>()
              ..submitQuiz(quizId: GetAllQuizDataSuccessState.quizId!),
      ...
      GoRoute(
          ...
          builder: (context, state) {
            ...
            return BlocProvider.value(
              value: context1!.read<InsMaterialCubit>()
                ..fetchMaterialFiles(lecId: lecId),
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          final AssignmentInstructorCubit cubit =
              extraData['cubit'] as AssignmentInstructorCubit;
      ...
      GoRoute(
        ...
        builder: (context, state) {
          ...
          final QuizInstructorCubit cubit =
              extraData['cubit'] as QuizInstructorCubit;
